import { ADD_AREA, SET_CURS, SET_LIST_VISIB, REM_AREA, SET_TEXT, GET_API_TO_ASYNC, GET_API_FROM_ASYNC, SET_ACCUR } from './stateConsts';
...
export const setListVisibAction = (number) => ({ type: SET_LIST_VISIB, ...number  });
